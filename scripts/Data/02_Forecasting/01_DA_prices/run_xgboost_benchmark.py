...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run the hourly DA naive + XGBoost benchmark.")
...
def main() -> None:
    args = parse_args()
    run_label = f"xgboost_{args.fs_level.lower()}_benchmark"
    config = replace(
    ...
    learner_timing = timing_summary[timing_summary["model"].str.startswith("xgboost_")]
